...
$config['NUM_DATE_OF_SEARCH'] = 10;
$config['APP_LOG_PATH'] = $_SERVER['DOCUMENT_ROOT']."/webapp/logs/";
$config['APP_LOG_FILE'] = "applog.log";
// $config['MASTER_FILE_ITEMS'] = "./files/ITEMS.json";
// $config['MASTER_FILE_SHOPS'] = "./files/SHOPS.json";
...
$config['URL_CATEGOIRES_HEADER'] = $config['api_url']."/products/categories/view/header/username/";
$config['URL_CUSTOMERS'] = $config['api_url']."/customers/";
$config['URL_CUSTOMERS_COUNT'] = $config['api_url']."/customers/count/";
$config['URL_CUSTOMERS_HEADER'] = $config['api_url']."/customers/view/header/username/";
$config['URL_SUPPLIERS'] = $config['api_url']."/suppliers/";
$config['URL_PAYMENT_METHODS'] = $config['api_url']."/systems/payments/methods/";
$config['URL_PAYMENT_METHODS_HEADER'] = $config['api_url']."/systems/payments/methods/view/header/username/";
...
$config['URL_STOCKS_HEADER'] = $config['api_url']."/stocks/view/header/username/";
$config['URL_STOCKSONHAND'] = $config['api_url']."/stocks/onhand/";
$config['URL_DELIVERY_NOTE'] = $config['api_url']."/stocks/dn/";
$config['URL_DELIVERY_NOTE_NEXT_NUM'] = $config['api_url']."/stocks/dn/getnextnum/";
$config['URL_DELIVERY_NOTE_PREFIX'] = $config['api_url']."/stocks/dn/getprefix/";
$config['URL_DELIVERY_NOTE_HEADER'] = $config['api_url']."/stocks/dn/view/header/username/";
$config['URL_ITEMS'] = $config['api_url']."/products/items/";
$config['URL_ITEMS_COUNT'] = $config['api_url']."/products/items/count/";
$config['URL_ITEMS_CATE'] = $config['api_url']."/products/items/category/";
$config['URL_ITEMS_HEADER'] = $config['api_url']."/products/items/view/header/username/";
$config['URL_INVENTORY_HAS_TRANSACTION_D'] = $config['api_url']."/inventory/invoices/transaction/d/";
$config['URL_PO_GRN'] = $config['api_url']."/stocks/po/grn/";
...
$config['URL_PO_GRN_HEADER'] = $config['api_url']."/stocks/po/grn/view/header/username/";
...
$config['URL_STOCK_ADJ_HEADER'] = $config['api_url']."/stocks/adj/view/header/username/";
...
$config['URL_PURCHASES_ORDER_HEADER'] = $config['api_url']."/purchases/order/view/header/username/";
...
$config['URL_EXPORT'] = $config['api_url']."/systems/export/";
$config['URL_MASTER'] = $config['api_url']."/systems/master/";
$config['URL_IMPORT'] = $config['api_url']."/systems/import/";