        ...
        <div class="modal-content">
            ...
            <!-- content -->
                <div class="container-fluid">
                    <p>Are you sure to delete customer code: <u><?=$to_deleted_num?></u>?</p>
                    <?php  if(!$confirm_show) : ?>
                    <p>Transaction : <?=$count?> transactions has included this customer. Cannot delete: <u><?=$to_deleted_num?></u></p>
                    <?php  endif; ?>
                </div>
            <!-- content end -->
            </div>
