...
<div class="container-fluid">
    <form class="" method="POST" id="this-form" action="<?=$submit_to?>" enctype="multipart/form-data">
        ...
        <div class="input-group mb-2 input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text" id=""><?=$this->lang->line("stocktake_export")?></span>
            </div>
            <a href="<?=$export_url?>" class="btn btn-info btn-sm" id="i-export-all"><?=$this->lang->line("common_export")?></a>
        </div>
        <div class="input-group mb-2 input-group-sm ">
            <div class="input-group-prepend">
                <span class="input-group-text" id=""><?=$this->lang->line("stocktake_import")?></span>
            </div>
            <input type="file" class="form-control col-3" id="i-import" name="i-import" value="" >
            <a href="#" class="btn btn-info btn-sm" id="i-import-submit"><?=$this->lang->line("common_import")?></a>
        </div>
...
<script>
    ...
    function render(){
        ...
        for(item in items){
            ...
            +"<td class='col-1'><input type='text' class='form-control form-control-sm item-input' id='qty_"+item+"' value='"+items[item].qty+"' /></td>"
    ...
    $("#i-export-all").on("click",function(){
        $(window).off('beforeunload');
    });
