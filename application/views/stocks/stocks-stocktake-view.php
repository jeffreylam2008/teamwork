...
<div class="container-fluid">
    <form class="" method="POST" id="this-form" action="<?=$submit_to?>" enctype="multipart/form-data">
        ...
        <div class="input-group mb-2 input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text" id="">Export Product File</span>
            </div>
            <a href="<?=$export_url?>" class="btn btn-info btn-sm" id="i-export-all">Export</a>
        </div>
        <div class="input-group mb-2 input-group-sm ">
            <div class="input-group-prepend">
                <span class="input-group-text" id="">Import Product File</span>
            </div>
            <input type="file" class="form-control col-3" id="i-import" name="i-import" value="" >
            <a href="#" class="btn btn-info btn-sm" id="i-import-submit">Import</a>
        </div>
...
<script>
    ...
    $("#i-export-all, #next").on("click",function(){
        $(window).off('beforeunload');
    });
    //construct
