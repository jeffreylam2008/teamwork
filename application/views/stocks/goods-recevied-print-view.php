...
function PrintHeader($grnnum ="", $supp = "", $date  = "", $shopcode = "", $shopname = "",$employee_code = "", $paymentmethod = "")
{
    print "
        <!-- print header --> 
        <table border=1 style='font-size:14px;'>
            <tbody>
            <tr>
                <td valign='top' width='160'>GRN Number</td>
                <td width='350'>
                    ".$grnnum."
                </td>
...
if(isset($items)){
    ...
    {
        PrintHeader($grn_num, $supp_name, $date, $shop_code, $shopname, $employee_code, $paymentmethodname);
        PrintBody($page[$j]);
        PrintFooter($total);
